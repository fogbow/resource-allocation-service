...
public class AAAController {
	...
	public AAAController(IdentityPlugin federationIdentityPlugin, IdentityPlugin localIdentityPlugin,
	...
	public Token getFederationToken(String federationTokenId) throws
	...
	public Token getLocalToken() throws PropertyNotSpecifiedException,
	...
	public void authorize(Token federationToken, Operation operation, OrderType type) throws UnauthorizedException {
		if (!this.authorizationPlugin.isAuthorized(federationToken, operation, type)) {
			throw new UnauthorizedException();
		}
	}

	public void authorize(Token federationToken, Operation operation, Order order) throws UnauthorizedException {
