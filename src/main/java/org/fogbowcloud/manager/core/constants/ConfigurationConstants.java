...
public class ConfigurationConstants {
	...
	public static final String FULFILLED_ORDERS_SLEEP_TIME_KEY = "fulfilled_orders_scheduler_period";
	...
	public static final String SSH_PRIVATE_PATH_KEY = "ssh_private_key";
