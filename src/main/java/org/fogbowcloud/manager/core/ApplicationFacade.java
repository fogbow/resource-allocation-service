...
public class ApplicationFacade {
	...
	public List<ComputeOrder> getAllComputes(String federationTokenValue) throws UnauthorizedException, UnauthenticatedException {
	...
	private List<Order> getAllOrders(String federationTokenValue, OrderType orderType) throws UnauthorizedException, UnauthenticatedException {
		this.aaaController.authenticate(federationTokenValue);
		Token federationToken = this.aaaController.getFederationToken(federationTokenValue);
