...
public class OpenStackV2NetworkPlugin implements NetworkPlugin<OpenStackV3Token> {
    ...
    @Override
    public void deleteInstance(String networkId, OpenStackV3Token openStackV3Token) throws FogbowManagerException, UnexpectedException {
        try {
            removeNetwork(openStackV3Token, networkId);
    ...
    protected String retrieveSecurityGroupId(String networkId, OpenStackV3Token openStackV3Token) throws FogbowManagerException, UnexpectedException {
