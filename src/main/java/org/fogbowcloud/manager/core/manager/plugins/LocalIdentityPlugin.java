...
public interface LocalIdentityPlugin {
    ...
    /**
     * Some cloud middleware require tokens to be renewed before its expiration date. This method
     * reissues a token against the identity service.
     *
     * @param token
    ...
    /**
     * @return If the identity provider endpoint is different from the service one, then this method
     *     should return its address. It should return null otherwise.
     */
    public String getAuthenticationURI();

    /**
     * Creates a copy of a token containing only public data, e.g. the public certificate of the
     * user.
     *
     * @param originalToken
