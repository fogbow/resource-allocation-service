...
public abstract class HttpBasedGenericRequestPlugin<T> implements GenericRequestPlugin<T> {
    ...
    @Override
    public abstract GenericRequestResponse  redirectGenericRequest(String method, String url, Map<String, String> headers, Map<String, String> body, T token) throws FogbowRasException;
