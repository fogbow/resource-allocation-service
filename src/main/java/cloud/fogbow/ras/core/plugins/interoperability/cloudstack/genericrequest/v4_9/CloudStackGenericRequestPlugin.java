...
public class CloudStackGenericRequestPlugin implements GenericRequestPlugin<CloudToken, HttpGenericRequest> {
    ...
    @Override
    public HttpResponse redirectGenericRequest(HttpGenericRequest genericRequest, CloudToken token) throws FogbowException {
        try {
