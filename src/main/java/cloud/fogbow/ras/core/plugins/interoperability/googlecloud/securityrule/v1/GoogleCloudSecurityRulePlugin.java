...
public class GoogleCloudSecurityRulePlugin implements SecurityRulePlugin<GoogleCloudUser> {
    ...
    @VisibleForTesting
    CreateFirewallRuleRequest buildCreateSecurityRuleRequest(SecurityRule securityRule, Order majorOrder, int securityRulePriority, String securityRuleName) {
    ...
    @VisibleForTesting
    boolean isPortAllowed(SecurityRule securityRule) {
    ...
    @VisibleForTesting
    List<SecurityRuleInstance> getSecurityRuleInstances(GetFirewallRulesResponse firewallRulesResponse, String networkName) {
    ...
    @VisibleForTesting
    SecurityRuleInstance createSecurityRuleInstance(String id, String directionString, String portRange, String cidr,
    ...
    @VisibleForTesting
    SecurityRuleInstance getSecurityRule(String securityRuleName, GoogleCloudUser cloudUser) throws FogbowException {
        String endpoint = this.prefixEndpoint
                + GoogleCloudConstants.PROJECT_ENDPOINT
                + GoogleCloudConstants.ENDPOINT_SEPARATOR
                + cloudUser.getProjectId()
