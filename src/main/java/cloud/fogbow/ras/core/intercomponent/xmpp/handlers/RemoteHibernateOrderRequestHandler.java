...
public class RemoteHibernateOrderRequestHandler extends AbstractQueryHandler {
    private static final Logger LOGGER = Logger.getLogger(RemotePauseOrderRequestHandler.class);

    private static final String REMOTE_HIBERNATE_ORDER = RemoteMethod.REMOTE_HIBERNATE_ORDER.toString();

    public RemoteHibernateOrderRequestHandler() {
        super(REMOTE_HIBERNATE_ORDER);
    }
    ...
    public IQ handle(IQ iq) {
        ...
        try {
            ...
            RemoteFacade.getInstance().hibernateOrder(senderId, orderId, systemUser, resourceType);
        } catch (Exception e) {
