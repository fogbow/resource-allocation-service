...
public class RemotePauseOrderRequest implements RemoteRequest<Void> {
    private static final Logger LOGGER = Logger.getLogger(RemotePauseOrderRequest.class);

    private Order order;

    public RemotePauseOrderRequest(Order order) {
        this.order = order;
    }
    ...
    public static IQ marshal(Order order) {
        ...
        Element queryElement = iq.getElement().addElement(IqElement.QUERY.toString(),
                RemoteMethod.REMOTE_PAUSE_ORDER.toString());
