...
public class RemoteResumeOrderRequest implements RemoteRequest<Void> {
    private static final Logger LOGGER = Logger.getLogger(RemoteResumeOrderRequest.class);

    private Order order;

    public RemoteResumeOrderRequest(Order order) {
        this.order = order;
    }
