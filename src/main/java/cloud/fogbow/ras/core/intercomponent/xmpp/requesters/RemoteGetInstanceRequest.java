...
public class RemoteGetInstanceRequest implements RemoteRequest<Instance> {
    private static final Logger LOGGER = Logger.getLogger(RemoteGetInstanceRequest.class);

    private Order order;

    public RemoteGetInstanceRequest(Order order) {
        this.order = order;
    }
