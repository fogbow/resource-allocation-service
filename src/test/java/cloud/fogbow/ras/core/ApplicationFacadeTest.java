...
//                authenticateAndAuthorize(Mockito.anyString(), Mockito.any(FederationUser.class), Mockito.anyString(),
...
//                Mockito.any(FederationUser.class), Mockito.anyString(), Mockito.any(Operation.class), Mockito.any(ResourceType.class));
...
//                Mockito.any(Order.class), Mockito.any(FederationUser.class));
//
//        // exercise
//        try {
//            application.getAllSecurityRules(FAKE_INSTANCE_ID, FAKE_FEDERATION_TOKEN_VALUE, ResourceType.PUBLIC_IP);
...
//                Mockito.anyString(), Mockito.anyString(), Mockito.anyString(), Mockito.any(FederationUser.class));
//
//        // exercise
//        try {
//            application.deleteSecurityRule(FAKE_INSTANCE_ID, FAKE_RULE_ID, FAKE_FEDERATION_TOKEN_VALUE,
...
//        PowerMockito.when(CloudConnectorFactory.getInstance()).thenReturn(cloudConnectorFactory);
//        Mockito.when(cloudConnectorFactory.getCloudConnector(Mockito.anyString(), Mockito.anyString())).thenReturn(localCloudConnector);
//        Mockito.when(localCloudConnector.genericRequest(Mockito.eq(genericRequest), Mockito.any(FederationUser.class))).thenReturn(expectedResponse);
//
//        // exercise
...
//                FAKE_FEDERATION_TOKEN_VALUE,
//                FAKE_USER_ID, FAKE_USER_NAME);
//        VolumeOrder order = new VolumeOrder(federationUser, FAKE_MEMBER_ID, FAKE_MEMBER_ID, "default", FAKE_VOLUME_NAME, 1
//        );
//
...
//        FederationUser federationUser = new FederationUser(FAKE_TOKEN_PROVIDER, FAKE_FEDERATION_TOKEN_VALUE,
//                FAKE_USER_ID, FAKE_USER_NAME);
//        ComputeOrder order = new ComputeOrder(federationUser, FAKE_MEMBER_ID, FAKE_MEMBER_ID, "default", FAKE_INSTANCE_NAME, 2, 2,
...
//        this.activeOrdersMap.put(computeOrder.getId(), computeOrder);
//
//        PublicIpOrder order = new PublicIpOrder(federationUser, FAKE_MEMBER_ID, FAKE_MEMBER_ID,
