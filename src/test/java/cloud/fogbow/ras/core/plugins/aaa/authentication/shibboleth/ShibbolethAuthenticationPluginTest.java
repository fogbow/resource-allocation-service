package cloud.fogbow.ras.core.plugins.aaa.authentication.shibboleth;
...
public class ShibbolethAuthenticationPluginTest {
	...
	@Test
	public void testIsAuthentic() throws UnavailableProviderException, InvalidKeyException,
	...
	@Test
	public void testIsNotAuthentic() throws UnavailableProviderException,
	...
	@Test
	public void testIsAuthenticIsNotLocalProvider() throws UnavailableProviderException {
		// set up
		String requestingMember = "anything";
	...
	@Test
	public void testIsNotAuthenticIsNotLocalProvider() throws UnavailableProviderException {
		// set up
		String requestingMember = "anything";
