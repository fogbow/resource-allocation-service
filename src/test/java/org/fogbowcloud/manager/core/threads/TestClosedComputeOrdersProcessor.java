...
public class TestClosedComputeOrdersProcessor extends BaseUnitTests {
    ...
    @Test
    public void testProcessClosedRemoteOrder() {

    }

    @Test
    public void testProcessClosedOrderFails() {
...
//    @Test
//    public void testProcessClosedLocalOrder() throws Exception {
//        Order localOrder = createLocalOrder();
//
//        OrderInstance orderInstance = new OrderInstance("fake-id");
//
//        SharedOrderHolders sharedOrderHolders = SharedOrderHolders.getInstance();
...
//        openOrdersList.addItem(order);
//
//        Mockito.doThrow(OrderStateTransitionException.class).when(this.closedComputeOrdersProcessor)
...
//        openOrdersList.addItem(order);
//
//        Mockito.doThrow(Exception.class).when(this.closedComputeOrdersProcessor).processOpenOrder(Mockito.any(Order.class));
//
//        this.thread = new Thread(this.closedComputeOrdersProcessor);
//        this.thread.start();
//
