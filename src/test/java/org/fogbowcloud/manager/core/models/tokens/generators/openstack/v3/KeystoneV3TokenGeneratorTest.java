...
//    }
//
//    //test case: createTokenValue must throw UnauthorizedRequestException when the http request is forbidden (403).
...
//
//        //exercise/verify
//        OpenStackV3Token token = this.keystoneV3TokenGenerator.createTokenValue(credentials);
//    }
//
//    //test case: check if createTokenValue throws UnauthenticatedUserException when the http request is Unauthorized (401).
...
//    }
//
//    //test case: check if createTokenValue throws InstanceNotFoundException when the http request is Not Found (404).
...
//    }
//
//    //test case: check if createTokenValue throws InvalidParameterException when the http request is Bad Request (400).
...
//    }
//
//    //test case: check if createTokenValue throws UnavailableProviderException when the http request host is Unknown.
...
//    }
//
//    //test case: check if createTokenValue throws InvalidParameterException when the credentials attributes is incomplete.
//    @Test (expected = InvalidParameterException.class)
