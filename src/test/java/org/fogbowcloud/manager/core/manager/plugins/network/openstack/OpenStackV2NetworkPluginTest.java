...
public class OpenStackV2NetworkPluginTest {
    private static final String NETWORK_HA_ROUTER_REPLICATED_INTERFACE =
    ...
    public void setUp() {
        ...
        this.defaultToken =
                new Token("accessId", new Token.User("user", "user"), new Date(), attributes);
    }
    ...
    public void testRequestInstanceWithoutTenantId() throws RequestException {
        ...
        openStackV2NetworkPlugin.requestInstance(token, null);
    }
    ...
    public void testGenerateJsonEntityToCreateNetwork() throws JSONException {
        ...
        Assert.assertEquals(DEFAULT_TENANT_ID,
                networkJsonObject.optString(OpenStackV2NetworkPlugin.KEY_TENANT_ID));
    ...
    public void testGenerateJsonEntityToCreateSubnetWithoutGateway() throws JSONException {
        ...
        JSONObject subnetJsonObject = generateJsonEntityToCreateSubnet
                .optJSONObject(OpenStackV2NetworkPlugin.KEY_JSON_SUBNET);
        Assert.assertTrue(
                subnetJsonObject.optString(OpenStackV2NetworkPlugin.KEY_GATEWAY_IP).isEmpty());
    }

    @Test
    public void testGenerateJsonEntitySubnetId() throws JSONException {
        String subnetId = "subnet";
        JSONObject generateJsonEntitySubnetId =
                this.openStackV2NetworkPlugin.generateJsonEntitySubnetId(subnetId);
    ...
    public void testGetRouterIdFromJson() throws JSONException {
        ...
        Assert.assertEquals(routerId,
                this.openStackV2NetworkPlugin.getRouterIdFromJson(routerJsonObject.toString()));
    }
    ...
    public void testGetSubnetIdFromJson() throws JSONException {
        ...
        Assert.assertEquals(subnetId,
                this.openStackV2NetworkPlugin.getSubnetIdFromJson(subnetJsonObject.toString()));
    }
    ...
    public void testGetInstanceFromJson() throws JSONException, IOException, RequestException {
        ...
        HttpResponse httpResponseGetNetwork =
                createHttpResponse(networkJsonObject.toString(), HttpStatus.SC_OK);
        HttpResponse httpResponseGetSubnet =
                createHttpResponse(subnetJsonObject.toString(), HttpStatus.SC_OK);
        Mockito.when(this.client.execute(Mockito.any(HttpUriRequest.class)))
                .thenReturn(httpResponseGetNetwork, httpResponseGetSubnet);

        NetworkOrderInstance instance =
                this.openStackV2NetworkPlugin.getInstance(this.defaultToken, "instanceId00");
        ...
        Assert.assertEquals(InstanceState.ACTIVE, instance.getState());
    ...
    @Test(expected = RequestException.class)
    public void testRemoveWithoutTenantId() throws RequestException {
        Token token = new Token("accessId", new Token.User("user", "user"), new Date(),
                new HashMap<String, String>());
        this.openStackV2NetworkPlugin.deleteInstance(token, "instanceId");
    }
    ...
    public void testRemoveInstance() throws IOException, JSONException, RequestException {
        ...
        portOneJsonObject.put(OpenStackV2NetworkPlugin.KEY_DEVICE_OWNER,
                NETWORK_HA_ROUTER_REPLICATED_INTERFACE);
        ...
        HttpResponse httpResponseGetPorts =
                createHttpResponse(portsJsonObject.toString(), HttpStatus.SC_OK);
        ...
        Mockito.when(client.execute(Mockito.any(HttpUriRequest.class))).thenReturn(
                httpResponseGetPorts, httpResponsePutRemoveInterface, httpResponseDeleteRouter,
                httpResponseDeleteNetwork);

        openStackV2NetworkPlugin.deleteInstance(defaultToken, networkId);
    ...
    public void testRemoveInstanceNullpointException() throws JSONException, IOException {
        ...
        try {
            ...
            Assert.assertEquals(HttpStatus.SC_BAD_REQUEST, e.getMessage());
            Assert.assertEquals(ResponseConstants.IRREGULAR_SYNTAX, e.getMessage());
        } catch (Exception e) {
            Assert.fail();
        }
    ...
    @Test
    public void testRemoveInstanceRemoveRouterBadRequestException()
        ...
        HttpResponse httpResponseDeleteNetwork = createHttpResponse("", HttpStatus.SC_OK);
        Mockito.when(client.execute(Mockito.any(HttpUriRequest.class))).thenReturn(
                httpResponseGetPorts, httpResponseDeleteRouter, httpResponseDeleteNetwork);
    ...
    @Test
    public void testRemoveInstanceRemoveNetworkBadRequestException()
            throws JSONException, IOException {
        JSONObject portOneJsonObject = new JSONObject();
        String networkId = "networkId";
        portOneJsonObject.put(OpenStackV2NetworkPlugin.KEY_NETWORK_ID, networkId);
    ...
    @Test
    public void testRemoveNetworkWithInstanceAssociatedException()
            throws JSONException, IOException, RequestException {
        String networkId = "networkId";
        ...
        HttpResponse httpResponseGetPorts =
                createHttpResponse(portsJsonObject.toString(), HttpStatus.SC_OK);
        HttpResponse httpResponseDeleteRouter =
                createHttpResponse(EMPTY, HttpStatus.SC_BAD_REQUEST);
        Mockito.when(this.client.execute(Mockito.any(HttpUriRequest.class)))
        ...
        Mockito.verify(this.openStackV2NetworkPlugin, Mockito.never())
                .removeNetwork(Mockito.any(Token.class), Mockito.anyString());
        ...
        Mockito.when(this.client.execute(Mockito.any(HttpUriRequest.class))).thenReturn(
                httpResponseGetPorts, httpResponsePutRequest, httpResponseDeleteRouter,
                httpResponseDeleteNetwork);
        ...
        Mockito.verify(this.openStackV2NetworkPlugin, Mockito.times(1))
                .removeRouter(Mockito.any(Token.class), Mockito.eq(routerId));
        Mockito.verify(this.openStackV2NetworkPlugin, Mockito.times(1))
                .removeNetwork(Mockito.any(Token.class), Mockito.eq(networkId));
    }
    ...
    public void testRequestInstance() throws IOException, RequestException {
        ...
        openStackV2NetworkPlugin.deleteInstance(defaultToken, null);
    ...
    public void testRequestInstancePostRouterError() throws IOException, RequestException {
        ...
        Mockito.when(client.execute(Mockito.any(HttpUriRequest.class)))
                .thenReturn(httpResponsePostRouter);


        Map<String, String> xOCCIAtt = new HashMap<String, String>();
        openStackV2NetworkPlugin.requestInstance(defaultToken, null);
    ...
    private NetworkOrder createNetworkOrder(String networkId, String address, String gateway,
        ...
        NetworkOrder order = new NetworkOrder(networkId, Mockito.mock(Token.class),
                requestingMember, providingMember, gateway, address, allocation);
        return order;
    }
