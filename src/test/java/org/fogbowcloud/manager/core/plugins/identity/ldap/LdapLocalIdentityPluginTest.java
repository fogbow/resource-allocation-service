...
//import org.fogbowcloud.manager.core.manager.plugins.behavior.federationidentity.ldap.LdapIdentityPlugin;
...
//        Mockito.doReturn(userName)
//                .when(ldapStoneIdentity)
//                .ldapAuthenticate(Mockito.eq(login), Mockito.eq(password));
//
