...
public class OpenStackAttachmentPluginTest {
    ...
    //test case: check if generateJsonAttach is generating allocationAllowableValues correct Json according to allocationAllowableValues random volumeId generated by VolumeOrder
    @Test
